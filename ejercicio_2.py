...
print("el valor ingresado en la variable numero_1 es:")
print(numero_1)
print("el valor ingresado en la variable numero_2 es:",numero_2)
...
multriplicacion = numero_1 * numero_2
print("el resultado de multiplicar",numero_1,"por",numero_2,"es:",multriplicacion)
